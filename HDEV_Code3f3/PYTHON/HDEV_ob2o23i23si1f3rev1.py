...
def fun_Find_Ipk_4Trq65C_mk_dat(ext_Duty_Cycle,i_TurnLab):
    ...
    mcApp.SetVariable("LabThermalCoupling", 0)                         # Coupling with Thermal- Operating Calculation
...
def fun_Driving_Duty(ext_Duty_Cycle,turns):
    ...
    mcApp.SetVariable("LabThermalCoupling_DutyCycle", 0)   # Coupling with Thermal Duty Cycle (0: No Coupled, 1: Loss -> Thermal 2 : Close Coupled)
    mcApp.SetVariable("LabThermalCoupling", 0)             # Coupling with Thermal <-> Lab Operating Point Caclulation
...
#calc option (Lab Operating Calculation <-> Thermal)
OP1thermalCouplingType=1 # 0: no thermal coupling 1: Loss-> Thermal # closed coupled 
OP2thermalCouplingType=1 # 0: no thermal coupling 1: Loss-> Thermal # closed coupled
...
### Lab: model Build tab### 
    ...
    if run_mode in ['IDE_run']:
        ...
        mcApp.SetVariable('ProximityLossModel',ProximityLossModel)
...
### Lab: Duty cycle tab###  -  peak performance  
    ...
    o_Op1_max_temp,Op1_max_pos,Op1_temp_dic, o_Op1_ipk,Op1_beta,Op1_after,o_Op1_ShaftToruqe, Op1_current_density,o_Op1_copper_area=fun_OP_temp_contraints(OP1,i_TurnLab,OP1thermalCouplingType)
