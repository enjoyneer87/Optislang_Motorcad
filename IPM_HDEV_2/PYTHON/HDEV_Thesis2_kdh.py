...
### Lab: peak performance
    ...
    ex, o_LabPeak_IPeak = mcApp.GetVariable("LabOpPoint_StatorCurrent_Line_Peak")    # Get shaft torque value
  ...
  # Calculation & Data management
    ...
    Peak_Torque_Array  = np.zeros(len(p_Speed_Peak_Array))              # Contiuous torque array initialisation
...
### Lab: Energy Consumption over drive cycle
  ...
  # Settings
    ...
    mcApp.SetVariable("DutyCycleType_Lab", 0)                 # Automotive drive cycle 0- custom 1 auto
    #mcApp.SetVariable("DrivCycle_MotorLAB", "WLTP Class 3")   # WLTP3 drive cycle
    mcApp.SetVariable("LabThermalCoupling_DutyCycle", 0)      # No coupling with Thermal 0 - No Coupling 1 2 Coupled 
